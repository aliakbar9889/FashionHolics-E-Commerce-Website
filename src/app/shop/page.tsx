      ...
      >
        ...
        {[
          ...
          >
            ...
            <Image
              src={src}
              alt={name} // Ensure alt text is properly defined
              layout="responsive" // Use layout="responsive" for better image responsiveness
              width={400} // Define width (adjust as needed)
              height={500} // Define height (adjust as needed)
